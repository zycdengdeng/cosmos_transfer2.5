...
{
    "name": "009",
    "prompt": "A realistic driving scene at an urban intersection with multiple lanes, traffic lights, road markings, and surrounding buildings. The scene captures a typical city road environment with clear visibility and detailed urban infrastructure.",
    "guidance": 3,
    ...
    "seed": 2025,
    "control_depth": {
        "path": "/mnt/zihanw/cosmos-transfer2.5/data_prepa/ftheta_camera_front_wide_120fov/depth/009_90frames_1280x720.mp4",
        "weight": 0.8
    },
    "control_vis": {
        "path": "/mnt/zihanw/cosmos-transfer2.5/data_prepa/ftheta_camera_front_wide_120fov/color/009_90frames_1280x720.mp4",
        "weight": 0.2
    }
}
EOFCONFIG
